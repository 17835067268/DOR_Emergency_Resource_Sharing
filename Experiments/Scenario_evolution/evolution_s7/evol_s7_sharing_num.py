...
##xiir比例数据读取(t2时刻)
df_x_iir = pd.read_csv("result/s7_x_iir_t2_stacked_with_r.csv")
...
number_share_in_t2.to_csv("s7_number_share_in_t2.csv",index=True)
number_share_out_t2.to_csv("s7_number_share_out_t2.csv",index=True) 
...
df_abs_mat_all.to_csv("s7_abs_shared_matrix_all_t2.csv", encoding="utf-8-sig")