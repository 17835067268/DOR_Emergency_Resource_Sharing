...
def compute_resource_consumption_t1(hir_t1, gir_numpy_t1, x_iir_t1, dir_all, scenario_t1=2, N_s=40):
...
bir_t1, hir_ns_t2 = compute_resource_consumption_t1(hir_t1, gir_numpy_t1, x_iir_t1, dir_all, scenario_t1=2, N_s=40) # shape (18,6)
...
out_of_sample_path = "evolution_sample/s2_simulated_demand_structured_Ns_20.csv"
...
shared_in_t2 = pd.read_csv("result/s2_number_share_in_t2.csv", index_col=0).to_numpy()
shared_out_t2 = pd.read_csv("result/s2_number_share_out_t2.csv", index_col=0).to_numpy()
...
# 保存为 CSV 文件
df_satisfaction_rate.to_csv("s2_t2_satisfaction_rate_matrix.csv", index=False)
df_satisfaction_rate_no_sharing.to_csv("s2_t2_satisfaction_rate_no_sharing_matrix.csv", index=False)
df_redundancy_rate.to_csv("s2_t2_redundancy_rate_matrix.csv", index=False) 
df_redundancy_rate_no_sharing.to_csv("s2_t2_redundancy_rate_no_sharing_matrix.csv", index=False) 
df_shortage_rate.to_csv("s2_t2_shortage_rate_matrix.csv", index=False)
df_shortage_rate_no_sharing.to_csv("s2_t2_shortage_rate_no_sharing_matrix.csv", index=False)
df_shortage_matrix.to_csv("s2_t2_shortage_matrix.csv", index=False)
df_shortage_matrix_no_sharing.to_csv("s2_t2_shortage_no_sharing_matrix.csv", index=False)
df_shortage_cost.to_csv("s2_t2_shortage_cost_matrix.csv", index=False)
df_shortage_cost_no_sharing.to_csv("s2_t2_shortage_cost_no_sharing_matrix.csv", index=False)
df_total_shortage_cost_per_subject.to_csv("s2_t2_total_cost.csv", index=False)
df_total_shortage_cost_no_sharing_per_subject.to_csv("s2_t2_total_cost_no_sharing.csv", index=False)
