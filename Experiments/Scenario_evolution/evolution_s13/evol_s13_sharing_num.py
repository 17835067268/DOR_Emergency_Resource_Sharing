...
# ------------------ 样本数据载入(样本内) ------------------ #
csv_path = "evolution_sample/s13_simulated_demand_structured_Ns_40.csv"
...
level_table = {
    ...
    2:  {1: "一般", 2: "较低", 3: "较低", "T1": "很低", "T2": "较低", "D": "较低"},
    3:  {1: "较低", 2: "较低", 3: "很低", "T1": "很低", "T2": "较低", "D": "较低"},
    4:  {1: "一般", 2: "较低", 3: "较低", "T1": "较低", "T2": "较低", "D": "较低"},
    5:  {1: "一般", 2: "较低", 3: "较低", "T1": "较低", "T2": "较低", "D": "一般"},
    ...
    11: {1: "较高", 2: "较高", 3: "一般", "T1": "一般", "T2": "较高", "D": "较高"},
    12: {1: "很高", 2: "较高", 3: "一般", "T1": "一般", "T2": "很高", "D": "很高"},
    13: {1: "很高", 2: "较高", 3: "较高", "T1": "较高", "T2": "较高", "D": "较高"},
...
# ------------------ t=2资源状态计算：bir_t2, hir_t3(均是确定的，shape为(18,6)) ------------------ #
def compute_resource_consumption_t1(hir_t2, gir_numpy_t2, x_iir_t2, dir_all, scenario_t2=13, N_s=40):
...
bir_t2, hir_ns_t3 = compute_resource_consumption_t1(hir_t2, gir_numpy_t2, x_iir_t2, dir_all, scenario_t2=13, N_s=40) 
...
# ------------------ 情景概率载入函数(这块需要载入的概率数据是已知t2时刻情景实现下，t3的概率转移矩阵) ------------------ #
def get_scenario_prob(day, csv_path="evolution_sample/scenario_probability_Marcov_t1_s13.csv"):
...
number_share_in_t2.to_csv("s13_number_share_in_t2.csv",index=True) 
number_share_out_t2.to_csv("s13_number_share_out_t2.csv",index=True) 
...
df_abs_mat_all.to_csv("s13_abs_shared_matrix_all_t2.csv", encoding="utf-8-sig")