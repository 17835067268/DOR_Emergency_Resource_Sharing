...
#     "district_subject": {"医用口罩": 0, "防护服": 0, "护目镜": 0}
# }
## （2）t1 全区所有主体仅r1_10单位gir_t1
# external_assistance_rules_t1 = {
#     "neighbourhood_committee": {"医用口罩": 10, "防护服": 0, "消毒液": 0, "护目镜": 0, "帐篷": 0},
#     "property_committee": {"医用口罩": 10, "防护服": 0, "消毒液": 0, "护目镜": 0,},
#     "town_subject": {"医用口罩": 10, "防护服": 0, "消毒液": 0, "护目镜": 0, "社区卫生服务中心医护人员": 0},
#     "district_subject": {"医用口罩": 10, "防护服": 0, "护目镜": 0}
# }
## （3）t1天仅前一天的感染社区得到支援
...
# def generate_external_support_t1_based_on_t0(
#     scenario_t0, subject_info, infected_communities, 
#     resource_set, external_assistance_rules_t1
# ):
#     infected_comms = infected_communities.get(scenario_t0, set())
...
#         rules=external_assistance_rules_t1
#     )
...
# gir_t1, gir_numpy_t1 = generate_external_support_t1_based_on_t0(
#     scenario_t0=scenario_t0,
#     subject_info=subject_info,
#     infected_communities=infected_communities,
#     resource_set=resource_set,
#     ##实验2-(2)(仅前一天疫区主体支援口罩180单位+共享)
#     # external_assistance_rules_t1={
#     #     "neighbourhood_committee": {"医用口罩": 40, "防护服": 0, "消毒液": 0, "护目镜": 0, "帐篷": 0},
#     #     "property_committee": {"医用口罩": 40, "防护服": 0, "消毒液": 0, "护目镜": 0},
#     #     "town_subject": {"医用口罩": 50, "防护服": 0, "消毒液": 0, "护目镜": 0, "社区卫生服务中心医护人员": 0},
#     #     "district_subject": {"医用口罩": 50, "防护服": 0, "护目镜": 0}
#     # }
#     ##实验2-(4)(仅前一天疫区主体r1-r6均匀分摊180单位)
#     external_assistance_rules_t1={
...
## (4) 实验2-(3) (全区所有主体均匀得到r1-r6 180单位gir_t1)
# gir_t1 = np.array([
#     [2, 3, 2, 3, 0, 0],
#     [2, 3, 2, 3, 0, 0],
#     [2, 3, 2, 3, 0, 0],
...
## (5) 实验2-(5）(全区所有主体均匀得到r1 180单位gir_t1)
# gir_t1 = np.array([
#     [12, 0, 0, 0, 0, 0],  # 第1个主体(前一天疫区)
#     [12, 0, 0, 0, 0, 0],  # 第2个主体(前一天疫区)
#     [10, 0, 0, 0, 0, 0],
#     [10, 0, 0, 0, 0, 0],
#     [10, 0, 0, 0, 0, 0],
#     [10, 0, 0, 0, 0, 0],
...
#     [9,  0, 0, 0, 0, 0],
#     [9,  0, 0, 0, 0, 0],
#     [12, 0, 0, 0, 0, 0],  # 第15个主体(前一天疫区街道)
#     [9,  0, 0, 0, 0, 0],
#     [9,  0, 0, 0, 0, 0],
#     [12, 0, 0, 0, 0, 0]   # 区
# ])

## (6) 实验2-(6）(全区所有主体均匀得到r1-r6 180单位gir_t1)
gir_t1 = np.array([
    [5, 5, 5, 5, 0, 0],   # 第1个主体(前一天疫区)
    [5, 5, 5, 5, 0, 0],   # 第2个主体(前一天疫区)
    [3, 2, 2, 1, 0, 0],
    [2, 2, 2, 1, 0, 0],
    [2, 2, 2, 1, 0, 0],
    [2, 2, 2, 1, 0, 0],
    ...
    [2, 2, 2, 1, 0, 0],
    [2, 2, 2, 1, 0, 0],
    [5, 5, 5, 5, 0, 0],   # 第15个主体(前一天疫区街道)
    [2, 2, 2, 1, 0, 0],
    [2, 2, 2, 1, 0, 0],
    [7, 7, 0, 7, 0, 0]   
])

gir_numpy_t1 = np.array(gir_t1)
...
df.to_csv("x_iir_t1_stacked_with_r.csv", index=False)
