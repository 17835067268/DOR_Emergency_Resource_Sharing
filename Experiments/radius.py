...
# e = 0.2
theta_s = np.array([0.654, 0.66, 0.674, 0.674, 0.652, 0.71, 0.712, 0.706, 0.694, 0.698, 0.704, 0.706, 0.702, 0.712])
# e = 0.4
# theta_s = np.array([1.308, 1.32, 1.348, 1.348, 1.304, 1.42, 1.424, 1.412, 1.388, 1.396, 1.408, 1.412, 1.404, 1.424])
# e = 0.6
# theta_s =  np.array([1.962, 1.98, 2.022, 2.022, 1.956, 2.13, 2.136, 2.118, 2.082, 2.094, 2.112, 2.118, 2.106, 2.136])
# e = 0.8
# theta_s = np.array([2.616, 2.64, 2.696, 2.696, 2.608, 2.84, 2.848, 2.824, 2.776, 2.792, 2.816, 2.824, 2.808, 2.848])
# e = 1.2
# theta_s = np.array([3.924, 3.96, 4.044, 4.044, 3.912, 4.26, 4.272, 4.236, 4.164, 4.188, 4.224, 4.236, 4.212, 4.272])
# e = 1.4
# theta_s = np.array([4.578, 4.62, 4.718, 4.718, 4.564, 4.97, 4.984, 4.942, 4.858, 4.886, 4.928, 4.942, 4.914, 4.984])
# e = 1.6
# theta_s = np.array([5.232, 5.28, 5.392, 5.392, 5.216, 5.68, 5.696, 5.648, 5.552, 5.584, 5.632, 5.648, 5.616, 5.696])
# e = 1.8
# theta_s = np.array([5.886, 5.94, 6.066, 6.066, 5.868, 6.39, 6.408, 6.354, 6.246, 6.282, 6.336, 6.354, 6.318, 6.408])
# e = 2
# theta_s = np.array([6.54, 6.6, 6.74, 6.74, 6.52, 7.1, 7.12, 7.06, 6.94, 6.98, 7.04, 7.06, 7.02, 7.12])
