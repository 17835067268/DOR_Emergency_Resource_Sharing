...
alpha = {1: 1, 2: 1, 3: 0.5, 4: 1, 5: 0.4, 6: 0.1, 7: 1, 8: 1, 9: 1, 10: 0.4, 11: 0.4, 12: 1}
beta = {1: 1.1, 2: 1, 3: 0.5, 4: 1, 5: 0, 6: 0, 7: 1.1, 8: 0, 9: 1, 10: 1, 11: 1, 12: 1 } 

base_mu = np.array([
    [12, 4, 5, 4, 1, 0, 12, 4, 4, 10000, 10000, 10],  
    [18, 6, 20, 6, 0, 0, 18, 6, 6, 0, 0, 10], 
    [12, 4, 5, 4, 1, 0, 12, 4, 4, 10000, 10000, 10],  
    [18, 6, 20, 6, 0, 0, 18, 6, 6, 0, 0, 10], 
    [12, 4, 5, 4, 1, 0, 12, 4, 4, 10000, 10000, 10],  
    [18, 6, 20, 6, 0, 0, 18, 6, 6, 0, 0, 10],
    ...
    [12, 4, 5, 4, 1, 0, 12, 4, 4, 10000, 10000, 10],   
    [18, 6, 20, 6, 0, 0, 18, 6, 6, 0, 0, 10],
    [24, 8, 0, 8, 0, 8, 24, 8, 8, 0, 0, 14], 
    [18, 6, 0, 6, 0, 6, 18, 6, 6, 0, 0, 12],
    [18, 6, 0, 6, 0, 6, 18, 6, 6, 0, 0, 12],
    [18, 6, 0, 6, 0, 6, 18, 6, 6, 0, 0, 12],
    [18, 6, 0, 6, 0, 6, 18, 6, 6, 0, 0, 12],
    [24, 8, 0, 8, 0, 0, 24, 8, 8, 0, 0, 14] 
])  
max_fluctuations = np.array([
    [2, 1, 1, 1, 0, 0, 2, 1, 1, 2, 2, 1],
    [2, 1, 2, 1, 0, 0, 2, 1, 2, 2, 2, 1],
    [2, 1, 1, 1, 0, 0, 2, 1, 1, 2, 2, 1],
    [2, 1, 2, 1, 0, 0, 2, 1, 2, 2, 2, 1],
    [2, 1, 1, 1, 0, 0, 2, 1, 1, 2, 2, 1],
    [2, 1, 2, 1, 0, 0, 2, 1, 2, 2, 2, 1],
    ...
    [2, 1, 1, 1, 0, 0, 2, 1, 1, 2, 2, 1],
    [2, 1, 2, 1, 0, 0, 2, 1, 2, 2, 2, 1],
    [3, 2, 0, 2, 0, 2, 3, 2, 2, 0, 0, 1],####
    [3, 2, 0, 2, 0, 2, 3, 2, 2, 0, 0, 1],
    [3, 2, 0, 2, 0, 2, 3, 2, 2, 0, 0, 1],
    [3, 2, 0, 2, 0, 2, 3, 2, 2, 0, 0, 1],
    [3, 2, 0, 2, 0, 2, 3, 2, 2, 0, 0, 1],
    [3, 2, 0, 2, 0, 0, 3, 2, 2, 0, 0, 1]
])
