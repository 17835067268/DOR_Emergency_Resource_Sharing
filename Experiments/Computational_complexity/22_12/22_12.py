...
# ------------------ 样本数据载入 ------------------ #
csv_path = "22_12_simulated_demand_structured_Ns_10.csv"
...
subject_location = {
    ...
    "18": {"latitude": 30.592643567069132, "longitude": 114.26897206080108},###
    "19": {"latitude": 30.607724089167778, "longitude": 114.24595061932298},
    "20": {"latitude": 30.588413726034446, "longitude": 114.28072056359557},
    "21": {"latitude": 30.61190702367985, "longitude": 114.26500075726067},
}
...
# 主体分组（ID是字符串）
neighbourhood_committee = ["0","2","4","6","8","10","12","14","16"]
property_committee = ["1","3","5","7","9","11","13","15","17"]
town_subject = ["18","19","20"]
district_subject = ["21"]
